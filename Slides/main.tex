...
\begin{frame}{The same code on clinical data: KIMORE}
  ...
  \end{columns}
  \vspace{0.15cm}
  \takeaway{Small clinical datasets are hard, in the published benchmark too. This is where a trivial baseline earns its place.}
\end{frame}
  ...
  \begin{columns}[t]
    \begin{column}{0.60\textwidth}
      ...
      \begin{itemize}
        ...
        \item \textbf{Evaluate over all folds}, next to a trivial baseline.
