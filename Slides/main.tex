...
\end{lstlisting}
      \begin{itemize}
        ...
        \item Fold 0: accuracy 0.89. All folds: \textbf{0.88}.
      \end{itemize}
    \end{column}
    \begin{column}{0.34\textwidth}
      \centering
  ...
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item It rescales, it does not centre. At 100 epochs the smallest models pay for that: MLP 0.56 on fold 0.
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Too few for \textbf{batch normalisation} statistics to settle: ResNet and Inception predicted a single class on most folds. Batches of 16 recovered them.
      \end{itemize}
    \end{column}
  \end{columns}
  \vfill
